...
namespace Altmedia\Sms\Observer;
...
class OrderSave implements ObserverInterface
{
    ...
    public function __construct(
        ...
        \Altmedia\Sms\Helper\Sms $helper,
    ...
    public function execute(Observer $observer)
    {
        ...
        $data = $this->scopeConfig->getValue(
            'altmedia/sms/altmedia_messages',
        ...
        if ($data) {
            ...
            if (!empty($message)) {
                ...
                $this->helper->sendSMS($order->getBillingAddress()->getTelephone(), $message);
            }
        }
    }
