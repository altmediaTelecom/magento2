<?php namespace Altmedia\Sms\Model;

use Altmedia\Sms\Api\Data\HistoryInterface;
...
class History extends \Magento\Framework\Model\AbstractModel implements HistoryInterface, IdentityInterface
{
     ...
     * CMS page cache tag
     */
    const CACHE_TAG = 'sms_history';

    /**
     * @var string
     */
    protected $_cacheTag = 'sms_history';
     ...
     * @var string
     */
    protected $_eventPrefix = 'sms_history';
    ...
    {
        $this->_init(\Altmedia\Sms\Model\ResourceModel\History::class);
    }
     ...
     *
     * @param int $id
     * @return \Altmedia\Sms\Api\Data\HistoryInterface
     */
