...
namespace Altmedia\Sms\Block\Adminhtml\Order\View;

use Altmedia\Sms\Model\Order;
use Magento\Framework\App\ObjectManager;
use Magento\Shipping\Helper\Data as ShippingHelper;
use Magento\Tax\Helper\Data as TaxHelper;

class Sms extends \Magento\Backend\Block\Widget
{
    /**
     * Core registry
     *
    ...
    {
        $onclick = "submitAndReloadArea($('order_sms').parentNode, '" . $this->getSubmitUrl() . "')";
        $button = $this->getLayout()->createBlock(\Magento\Backend\Block\Widget\Button::class)
            ->setData([
                'label' => __('Send'), 'class' => 'action-save action-secondary',
                'onclick' => $onclick,
            ]);
    ...
    {
        return $this->getUrl('sms/order', ['order_id' => $this->getOrder()->getId()]);
    }
}
